			...
			<div className="max-w-5xl m-auto md:grid grid-cols-3 gap-8">
				...
				<div className="col-span-2">
					...
					<p className="py-2 text-gray-600 indent-10">
						...
						I have a lot of libraries that I&apos;m interested like webGL,
						web3, 3D, animation and Ruby on Rails but for now I just want
						to get my first job. I have done a lot of projects that I try
						to practice but it feels like it&apos;s not the real project
						so I want to do the real project haha.
					</p>
					<p className="py-2 text-gray-600 indent-10">
						...
						that it&apos;s better than the usual way and we can recommend
						while improving each other.
					</p>
				</div>
			</div>
		</div>
